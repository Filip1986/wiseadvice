...
function ContentHandler(db, mongodb) {
  ...
  /*ARTA*/
  var anunturi = db.collection("anunturiRomanesti");
  ...
  var fabule = db.collection("fabule");
  var poezii = db.collection("poezii");
  var povesti = db.collection("povesti");
  ...
  this.getBancuriAnimale = function (req, res, next) {
    bancuri_animale.find().toArray(function (err, items) {
      ...
      console.log("err", err)
      console.log("Found " + items.length + " bancuriAnimale");
  ...
  /*GET FABULE*/
  this.getFabule = function (req, res, next) {
    fabule.find().toArray(function (err, items) {
      "use strict";
      if (err) {
        throw err;
      }
      ...
      console.log("err", err)
      console.log("Found " + items.length + " fabule");
  ...
  /*GET POEZII*/
  this.getPoezii = function (req, res, next) {
    poezii.find().toArray(function (err, items) {
      "use strict";
      if (err) {
        throw err;
      }
      ...
      console.log("err", err)
      console.log("Found " + items.length + " poezii");
  ...
  /*GET POVESTI*/
  this.getPovesti = function (req, res, next) {
    povesti.find().toArray(function (err, items) {
      "use strict";
      if (err) {
        throw err;
      }
